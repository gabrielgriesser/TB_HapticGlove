...
public class SenseGlove_Object : MonoBehaviour
{
    ...
    public bool GetUpdateWrist()
    {
        return this.updateWrist;
    }

    public void SetUpdateWrist(bool enable)
    {
        this.updateWrist = enable;
    }
    ...
    public bool LinkToGlove(int gloveIndex)
    {
        ...
        {
            Debug.LogWarning("Could not Link the Sense Glove because it has already been assigned. Unlink it first by calling the UnlinkGlove() Method.");
        }
        return false;
    }
