...
public class SenseGlove_Trigger : SenseGlove_Detector
{
    ...
    protected override void FireDetectEvent(SenseGlove_HandModel model)
    {
        ...
        else if (this.effectToShow.activeSelf && this.effectToShow.GetComponent<SenseGlove_Button2>() != null)
        {
            if (this.effectToShow.GetComponent<SenseGlove_Button2>().isCalibrating)
