	...
	public class Hi5_Interaction_Item_Collider : Hi5_Glove_Interaction_Collider 
	{
		...
		override protected void OnCollisionEnter(Collision collision)
		{
			...
			if (itemObject.mObjectType == EObject_Type.ECommon)
			{
				...
				/// GABRIEL ICI
				/// Inutile + Créé des crash de l'application 
				/*
				 if(FindParentContainsName(collision.gameObject, "HI5_Right"))
				{
					HI5.HI5_Manager.EnableRightVibration(100);
				}
				else if(FindParentContainsName(collision.gameObject, "HI5_Left"))
				{
					HI5.HI5_Manager.EnableLeftVibration(100);
				}*/
				...
				{
					//Debug.Log("COLLISION MAIN DROITE : " + collision.gameObject.name);
