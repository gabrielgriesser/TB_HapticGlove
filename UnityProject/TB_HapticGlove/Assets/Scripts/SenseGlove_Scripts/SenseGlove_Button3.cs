...
/// </summary>
public class SenseGlove_Button3 : MonoBehaviour
{
    ...
    {
        this.gloveLeft.SendBuzzCmd(whichFingers, hapticForce, hapticDuration);
        this.gloveRight.SendBuzzCmd(whichFingers, hapticForce, hapticDuration);
