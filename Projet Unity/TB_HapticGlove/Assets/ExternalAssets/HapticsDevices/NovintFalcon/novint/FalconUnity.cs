...
//				Debug.Log ("Received So Far:");
    ...
    public static void LaunchServer()
    {
        try
        {
            System.Diagnostics.Process.Start(DemoParameters.FalconServerPath);
        }
        catch (Exception e)
        {
            Debug.Log("Error when trying to launch Falcon server " + e);
        }
    }
	...
	public static void CloseServer()
	{
		try
        {
            foreach( System.Diagnostics.Process p in System.Diagnostics.Process.GetProcessesByName("FalconServer"))
			{
				p.CloseMainWindow();
			}
        }
...
public class FalconUnity
{
	public static void launchServer()
	{
		FalconUnityCall.LaunchServer();
	}

	public static void closeServer()
	{
		FalconUnityCall.CloseServer();
	}
