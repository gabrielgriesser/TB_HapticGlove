...
public class SenseGlove_Trigger : SenseGlove_Detector
{
    ...
    /// <summary> Saved color of button </summary>
    private Color color;
    ...
    protected override void FireDetectEvent(SenseGlove_HandModel model)
    {
        ...
        if (!this.effectToShow.activeSelf)
        {
            this.SetEffectObject(true);
        }
        //To stop calibration if the associated button is repressed       
        else if (this.effectToShow.activeSelf && this.effectToShow.GetComponent<SenseGlove_Button_Calibration>() != null)
        {
            if (this.effectToShow.GetComponent<SenseGlove_Button_Calibration>().IsCalibrating)
    ...
    protected override void Start()
    {
        ...
        if (this.transform.GetComponent<Renderer>())
            this.color = this.transform.GetComponent<Renderer>().material.color;
